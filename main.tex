...
\todo[inline]{fill this in with an introduction to the argument we are making}
...
\todo{REPLACE THIS WITH THE ONE THAT HAS THE VIOLIN PLOT?}
\todo[color=green]{stats}
\todo{caption}
	\begin{figure}[!h]
...
\todo[color=red,inline]{Fill this in with the figures}
