...
\todo[color=orange, inline]{MORE HERE about other things CE can or can't do}
...
\todo[inline]{remove "proposal", revise this paragraph for my thesis statement.}
...
\todo[inline]{fix figure below so that it's two separate figures. Separtae the mean entropy to its own figure.}
	\begin{figure}[!h]
...
\todo[inline]{TODO - add paragraph describing/speculating about why Benign loses EQU almost as well as Harsh}
...
%@RCK - agree.
\todo[inline]{add a sentence emphasiszing that it's an indirect effect.}
...
\todo[inline]{More about how this question is still open}
...
\section{Results and Discussion}
\todo[inline]{fill this in with a general overview of the argument}
...
\section{Background}
\todo[color=red,inline]{add more with some coverage of what research has already been done in this area, and where this all fits in the context}
...
\todo[inline]{[TODO - more discussion of what each treatment is intended to cover]}
...
\todo[color=red,inline]{prose this out}
...
\todo[color=red,inline]{fill this in about the prior research done in this area}
...
\todo[inline]{more details about each treatment}
...
\todo[color=red,inline]{TODO fill this in with more detail of each treatment}
...
\todo[inline]{fill this in, recapitulating the argument and framing about balancing of fitness effects.}

\chapter{Conclusion}
\label{chap:conclusion}
\todo[color=red,inline]{FILL THIS IN - Synthesis of all results and how it all fits together to paint a picture of how CE works.}
...
\todo[color=red,inline]{FILL THIS IN with cycle length sweeps}
...
In order to identify an optical cycle time to support our experiments, we surveyed a series of cycle lengths, and measured task performance rates in both benign and harsh changing environments (Fig~...\todo{figures})

%=[FIGURE - complex environment task discovery]
\todo[color=green]{stats}
\todo{caption}
	\begin{figure}[!h]
	\missingfigure{$ce-task_performance_by_cycle_length control$}
	\missingfigure{$ce-task_performance_by_cycle_length$ benign}
	\missingfigure{$ce-task_performance_by_cycle_length$ harsh}
	%\includegraphics[trim={0 0 0 0}, clip, width=0.35\columnwidth]{figures/A1/ce-task_performance_by_cycle_length__control.png}
	%\includegraphics[trim={0 0 0 0}, clip, width=0.35\columnwidth]{figures/A1/ce-task_performance_by_cycle_length__benign.png}
	%\includegraphics[trim={0 0 0 0}, clip, width=0.35\columnwidth]{figures/A1/ce-task_performance_by_cycle_length__harsh.png}
	\caption{\textbf{Survey of task execution} for a series of cycle-lengths. [TODO DESCRIPTION AND STATS]%
	}
	\label{fig:lte-bonus_hgt_vs_task_performance}
	\end{figure}

We found that, of our surveyed values, a cycle time of 1000 updates (roughly 30 generations) both provided adequate time for traits to evolve and fix, but also not enough time for drift to destroy alternate-phase traits. Cycle times that were too short never acquired and fixed adaptive traits, while in too-long cycles, the fluctuating tasks would take much longer to re-evolve, and populations drifted away from the regions of the mutational landscape that contained them. 

%%%%%%%% APPENDIX B
\chapter{Experimentally Deriving Parameters for HGT Recombination Probability and Bonus Levels}
\label{appendix:hgt_sweep}
\todo[color=red,inline]{FILL THIS IN with bonus and probability sweeps}

\section{Probability Sweep}
...
\todo{caption}
	\begin{figure}[!h]
	%\missingfigure{$ce-task_performance_by_cycle_length$ harsh}
	\includegraphics[trim={0 0 0 0}, clip, width=0.75\columnwidth]{figures/A2/hgt-probabilitysweep-hgtuse.png}
