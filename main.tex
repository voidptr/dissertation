...
%=cycle length
Each complete cycle lasted 1,000 updates, and the whole experimental run extended for 200,000 updates.
%=static environment
...
\todo[inline]{reword above to explain the meaning of ephemeral more clearly}
...
\todo[inline]{add something there}
...
\todo[inline]{expand above per Mike's comment}
...
\todo[inline]{expand speculation per mike's comment}
...
\todo[inline]{why does this happen?} 
