...
\chapter{Alternatives to the Grazing Hypothesis: Changing Environments Promote the Evolution of Horizontal Gene Transfer}
...
\subsubsection{Changing environments elevate HGT use}
...
\subsubsection{Other mutation types are not elevated in response to HGT}
...
\subsubsection{Mutation fitness effect correlate with mutagen use}
Measured HGT fragment uptake in four conditions - 0Static, BStatic, 0CE, BCE.
...
\subsubsection{HGT mutations increase evolved probability of beneficial phenotype switching}
...
\subsubsection{HGT derives most benefit from on-cycle fragments, but not all}
...
\chapter{Horizontal Gene Transfer Promotes Long Term Evolution}

\section{Background}
\section{Methods}
\section{Results and Discussion}

\chapter{Horizontal Gene Transfer As Most Preferred Mutation}
