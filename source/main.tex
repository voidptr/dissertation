...
For the treatments corresponding to the first set of hypotheses, I will create two new mutagenic instructions to trigger uptake of fragments. One of these instructions will confer an energy bonus upon uptake, while the other will not. Both instructions will incur a random chance of recombining the fragment into the genome at a homologous location. % @RCK This jives with how natural competence works in biological organisms. Integration can't really happen without homologous recombination. 
